...
export default function TopNav() {
  ...
  return (
    <div className="navbar sticky top-0 shadow-md px-4 py-3 flex items-center justify-between bg-[#222831] text-white z-50 sm:opacity-75 opacity-100">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-16 left-0 w-full bg-[#222831] shadow-lg flex flex-col items-center space-y-4 py-4 lg:hidden opacity-100">
          {user ? (
            <>
